...
public:
	...
	static Color FromHSB(float hue, float saturation, float brightness)
	{
		...
		if (h < 1) return Color(brightness * 255, t * 255, p * 255);
		else if (h < 2) return Color(q * 255, brightness * 255, p * 255);
		else if (h < 3) return Color(p * 255, brightness * 255, t * 255);
		else if (h < 4) return Color(p * 255, q * 255, brightness * 255);
		else if (h < 5) return Color(t * 255, p * 255, brightness * 255);
		else return Color(brightness * 255, p * 255, q * 255);
	}
	...
	static Color FromHSV(float h, float s, float v)
	{
		...
		default: return Color(v * 255, p * 255, q * 255);
		}
	}
